...
import cn.ming.springboot.task.config.job.DemoJob01;
import cn.ming.springboot.task.config.job.DemoJob02;
import org.quartz.*;
...
public class ScheduleConfiguration {
    ...
    public static class DemoJob01Configuration {
        ...
        public Trigger demoJob01Trigger() {
            ...
            SimpleScheduleBuilder scheduleBuilder = SimpleScheduleBuilder.simpleSchedule()
                    .withIntervalInSeconds(5) // 频率。 //每 5 秒执行一次，无限重复的调度计划
                    .repeatForever(); // 次数。
            // Trigger 构造器
    ...
    public static class DemoJob02Configuration {
        ...
        public Trigger demoJob02Trigger() {
            // 基于 Quartz Cron 表达式的调度计划的构造器 每第 10 秒执行一次
